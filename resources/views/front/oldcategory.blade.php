                       ...
                       @endphp --}}
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn" href="javascript:void(0)" onclick="home_add_to_cart('{{$productArr->id}}','{{$product_attr[$productArr->id][0]->wattage}}')"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
