...
<html class="no-js" lang="en">
    <head> 
        ...
        <title>admin - Shiksha light</title>
        <meta name="description" content="">
        <meta name="keywords" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        
        <link rel="icon" href="{{ asset('backend_assets/favicon.png') }}" type="image/x-icon" />
    ...
    <body class="home-gradient-bg">
		<div class="container ">
			<div class="d-flex justify-content-between my-5">
				<div>
					<a href="https://arthemic.com/products/radmin/">
		            	<img height="30" src="{{ asset('backend_assets/img/logo.png') }}">
		            </a>
				</div>
				<div>
	    	...
	    	<div class="banner-text m-4 d-relative">
	    		<img height="50" class="d-absolute left-0"  src="{{asset('backend_assets/img/p1.png')}}">
	    		<img height="300" class="d-absolute"  src="{{asset('backend_assets/img/s1-2.png')}}">
	    		<img height="50" class="d-absolute right-0"  src="{{asset('backend_assets/img/s2-2.png')}}">
	    		Let your engineers <br> build the backend!
	    	</div>

	    	<div class="radmin-bannner text-center">
	    		<img  src="{{asset('/backend_assets/img/radmin.jpg')}}">
	    	</div>
