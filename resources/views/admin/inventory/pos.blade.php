...
<head>
	<title>POS | Admin - Shiksha light</title>
...
<body id="app" >
			        ...
			        <div class="customer-area">
			        	...
			        	<div class="row pos-products layout-wrap" id="layout-wrap">
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1 pos-product-card">
			        				<div class="d-flex card-img">
			        					<img src="backend_assets/img/products/headphone.webp" alt="Donec sit amet est at sem iaculis aliquam." class="list-thumbnail responsive border-0">
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1 pos-product-card">
			        				<div class="d-flex card-img">
			        					<img src="backend_assets/img/products/ipone-6.jpg" alt="Donec sit amet est at sem iaculis aliquam." class="list-thumbnail responsive border-0">
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1 pos-product-card">
			        				<div class="d-flex card-img">
			        					<img src="backend_assets/img/products/bag.webp" alt="Donec sit amet est at sem iaculis aliquam." class="list-thumbnail responsive border-0">
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1 pos-product-card">
			        				<div class="d-flex card-img">
			        					<img src="backend_assets/img/products/camera.webp" alt="Donec sit amet est at sem iaculis aliquam." class="list-thumbnail responsive border-0">
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1 pos-product-card">
			        				<div class="d-flex card-img">
			        					<img src="backend_assets/img/products/joystick.webp" alt="Donec sit amet est at sem iaculis aliquam." class="list-thumbnail responsive border-0">
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1 pos-product-card">
			        				<div class="d-flex card-img">
			        					<img src="backend_assets/img/products/jacket.webp" alt="Donec sit amet est at sem iaculis aliquam." class="list-thumbnail responsive border-0">
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1 pos-product-card">
			        				<div class="d-flex card-img">
			        					<img src="/backend_assets/img/products/watch.webp" alt="Donec sit amet est at sem iaculis aliquam." class="list-thumbnail responsive border-0">
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1 pos-product-card">
			        				<div class="d-flex card-img">
			        					<img src="backend_assets/img/products/tshirt.jpg" alt="Donec sit amet est at sem iaculis aliquam." class="list-thumbnail responsive border-0">
	    				...
	    				<div class="product-cart mb-3">
	    					<div class="cart-item d-flex mb-2">
	    						<div class="width-50 d-flex">
	    							<img src="backend_assets/img/products/headphone.webp" alt="" class="img-fluid img-50">
	    							<div class="pl-3">
	    					...
	    					<div class="cart-item d-flex mb-2">
	    						<div class="width-50 d-flex">
	    							<img src="backend_assets/img/products/joystick.webp" alt="" class="img-fluid img-50">
	    							<div class="pl-3">
	    					...
	    					<div class="cart-item d-flex mb-2">
	    						<div class="width-50 d-flex">
	    							<img src="backend_assets/img/products/watch.webp" alt="" class="img-fluid img-50">
	    							<div class="pl-3">
    ...
    <div class="modal fade edit-layout-modal pr-0 " id="InvoiceModal" role="dialog" aria-labelledby="InvoiceModalLabel" aria-hidden="true">
	    <div class="modal-dialog mw-70" role="document">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                <div class="card-header"><h3 class="d-block w-100">Admin<small class="float-right">07/10/2021</small></h3></div>
	                <div class="card-body">
	                    <div class="row invoice-info">
	                        <div class="col-sm-4 invoice-col">
	                            From
	                            <address>
	                                <strong>Admin,</strong><br>795 Folsom Ave, Suite 546 <br>San Francisco, CA 54656 <br>Phone: (123) 123-4567<br>Email: info@admin.com
	                            </address>
	                        </div>
	                        <div class="col-sm-4 invoice-col">
	                            To
	...
	<!-- initiate scripts-->
	<script src="{{ asset('backend_assets/all.js') }}"></script>
